Public Class frmNotepadDemo
    ...
    Private Sub NewToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles NewToolStripMenuItem.Click
        If Me.Text = "New" And RichTextBox1.TextLength <> 0 Then

            If MessageBox.Show("DO YOU WANT TO SAVE ", "Demos 2016-17", MessageBoxButtons.YesNo, MessageBoxIcon.Warning, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
                If SaveFileDialog1.ShowDialog = Windows.Forms.DialogResult.OK Then
                    RichTextBox1.SaveFile(SaveFileDialog1.FileName, RichTextBoxStreamType.PlainText)
                    Me.Text = "New"
                    RichTextBox1.Clear()
