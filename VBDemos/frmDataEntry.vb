...
Public Class frmDataEntry
    ...
    Private Sub btnUpdate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnUpdate.Click
        ...
        'Dim strquery As String = "insert into student_master values(1,'SUTEX BCA', '9879879870','sbccas.amroli@gmail.com','BCA','SURAT')"
        Dim strquery As String = "UPDATE student_master SET sname='" & txtName.Text & "',semail='" & _
                                txtEmail.Text & "',smobile = '" & txtMobile.Text & "',scity='" & cmbCity.SelectedItem & _
                                "',scourse='" & cmbCOurse.SelectedItem & "' WHERE sid=" & txtRollNo.Text & ""
